        ...
        if st.session_state.analysis_complete:
            ...
            with tab1:
                ...
                **What does this score mean?**
                ...
                This score is calculated based on how many of the skills from the Job Description were found in your resume. 
                
                - **> 70% (Great Match):** You are a strong fit for this role.
                - **40-70% (Good Match):** You are a good fit, but could improve by adding more skills.
                - **< 40% (Low Match):** This role may not be a good fit, or your resume needs significant updates.
                """)
                # --- END NEW CONTENT ---

                if results['match_score'] < 50:
                    st.error("**This is a low match. Your main priority should be adding the 'Missing Skills' from the next tab.**")
                else:
            ...
            with tab2:
                ...
                st.info("Great job! Your resume already contains these key skills. Make sure they are featured prominently in your experience section.")
                # --- END NEW CONTENT ---
            ...
            with tab3:
                ...
                **What does this score mean?**
                ...
                A high score here means your resume is well-structured and easy for a recruiter to read.
                """)
                # --- END NEW CONTENT ---
